...
const getMe = async ()=>{
    ...
    const response = await fetch("".concat(API_URL, "/auth/me"), {
        headers: {
...
const getDashboard = async ()=>{
    ...
    const response = await fetch("".concat(API_URL, "/user/dashboard"), {
        headers: {
            Authorization: "Bearer ".concat(token)
        }
    });
        ...
        "AuthProvider.useEffect": ()=>{
            const checkAuth = {
                "AuthProvider.useEffect.checkAuth": async ()=>{
                    ...
                    try {
                        const userData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMe"])();
                        setUser(userData);
