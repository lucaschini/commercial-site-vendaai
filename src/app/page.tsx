      ...
      <header className="relative z-10 bg-white/10 backdrop-blur-[20px] border-b border-white/20 shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-8 text-white">
            <a
              href="#how"
              className="hover:drop-shadow-[0_4px_10px_rgba(255,255,255,0.5)] transition-all"
            >
              Como Funciona
            </a>
            <a
      ...
      <main className="relative z-10 px-6 md:px-12 lg:px-24">
        ...
        <section className="flex flex-col items-center text-center mt-20 mb-32">
          <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 drop-shadow-[0_4px_20px_rgba(0,0,0,0.3)] max-w-5xl">
            Como nós te ajudamos a <br className="hidden md:block" /> vender
            melhor <br className="hidden md:block" /> com nossa IA?
          </h1>
          ...
          <div className="w-full max-w-4xl h-96 bg-white/10 backdrop-blur-[20px] border border-white/20 rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.3)] flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-white/80 text-lg">
                Venda AI é a melhor ferramenta para vendas inteligentes.
              </p>
            </div>
          </div>
        </section>
            ...
            {[
              {
                num: "1",
                title: "Conecte",
                desc: "Integre o Venda.AI às suas plataformas de reunião favoritas. Zoom, Meet, Teams - funciona com todas.",
              },
              {
                num: "2",
                title: "Analise",
                desc: "Nossa IA escuta, processa e identifica oportunidades de venda em tempo real durante suas reuniões.",
              },
              {
                num: "3",
                title: "Venda Mais",
                desc: "Receba insights instantâneos, sugestões de fechamento e follow-ups personalizados para cada cliente.",
              },
            ].map((step) => (
              <div
                key={step.num}
              ...
              >
                <div
                  className={`w-16 h-16 bg-purple-500 rounded-full mx-auto mb-6 flex items-center justify-center shadow-lg`}
                >
            ...
            {[
              {
                icon: "📧",
                title: "Vendas B2B",
                desc: "Analise reuniões comerciais complexas e identifique pontos de dor dos prospects",
                bg: "bg-blue-500/20",
              },
              {
                icon: "✓",
                title: "Consultoria",
                desc: "Capture necessidades dos clientes e gere propostas mais assertivas",
                bg: "bg-green-500/20",
              },
              {
                icon: "⭐",
                title: "SaaS",
                desc: "Otimize demos de produto e identifique features mais valorizadas",
                bg: "bg-purple-500/20",
              },
              {
                icon: "📊",
                title: "Imobiliária",
                desc: "Entenda preferências de clientes e acelere o processo de vendas",
                bg: "bg-orange-500/20",
              },
              {
                icon: "💰",
                title: "Financeiro",
                desc: "Analise perfil de risco e personalize ofertas de produtos financeiros",
                bg: "bg-red-500/20",
              },
              {
                icon: "🛒",
                title: "E-commerce",
                desc: "Melhore atendimento ao cliente e aumente conversão em vendas online",
                bg: "bg-cyan-500/20",
              },
            ].map((app, i) => (
              <div
              ...
              >
                <div
                  className={`w-12 h-12 ${app.bg} backdrop-blur-lg rounded-lg mb-4 flex items-center justify-center text-2xl`}
                >
                  {app.icon}
                </div>
            ...
            {[
              {
                ...
                desc: "Converta automaticamente suas conversas em texto com 99% de precisão, em português e outros idiomas.",
                gradient: "from-blue-500 to-purple-500",
              },
              {
                icon: "😊",
                title: "Análise de Sentimentos",
                desc: "Entenda o humor e a receptividade do cliente durante a conversa para ajustar sua abordagem.",
                gradient: "from-purple-500 to-pink-500",
              },
              {
                icon: "💡",
                title: "Insights Instantâneos",
                desc: "Receba sugestões em tempo real sobre como conduzir a conversa e quais perguntas fazer.",
                gradient: "from-pink-500 to-orange-500",
              },
              {
                icon: "📄",
                title: "Relatórios Detalhados",
                desc: "Gere resumos completos de cada reunião com pontos-chave, próximos passos e oportunidades identificadas.",
                gradient: "from-orange-500 to-red-500",
              },
              {
                icon: "🔗",
                title: "Integração CRM",
                desc: "Sincronize automaticamente com Salesforce, HubSpot, Pipedrive e outros CRMs populares.",
                gradient: "from-green-500 to-teal-500",
              },
              {
                icon: "🔒",
                title: "Segurança Total",
                desc: "Criptografia end-to-end e conformidade com LGPD e GDPR para proteger dados sensíveis.",
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`w-12 h-12 bg-gradient-to-br ${feature.gradient} rounded-lg flex items-center justify-center flex-shrink-0 text-2xl shadow-lg`}
                  >
                    {feature.icon}
                  </div>
                  <div>
        ...
        <section id="faq" className="mb-32">
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            {[
              {
                q: "Como o Venda.AI protege a privacidade dos dados?",
                a: "Utilizamos criptografia de ponta a ponta e seguimos rigorosamente as normas da LGPD e GDPR.",
              },
              {
                q: "Qual é a precisão da transcrição?",
                a: "Nossa IA tem 99% de precisão na transcrição em português e suporta mais de 30 idiomas.",
              },
              {
                q: "Funciona com quais plataformas de reunião?",
                a: "Integramos com Zoom, Google Meet, Microsoft Teams, Webex, GoToMeeting e outras principais plataformas.",
              },
              {
                q: "Existe um período de teste gratuito?",
                a: "Sim! Oferecemos 14 dias grátis com acesso completo a todas as funcionalidades.",
              },
            ].map((faq, i) => (
              <details
                key={i}
                className="bg-white/10 backdrop-blur-[20px] border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 group"
              >
